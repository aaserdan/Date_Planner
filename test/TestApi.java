...
public class TestApi {
    ...
    /**
     * It is calling the FoodAPIAdapter to call the FoodAPI to get the
     * restaurants from the Yelp API, and prints out the restaurants
     *
     * @param _term
     * @param _city
     * @param _limit
    ...
    /**
     * It is calling the WeatherAPIAdapter to call the OpenWeatherMapAPI to get
     * the weather from the OpenWeatherMap API , and prints out the weather
     *
     * @param _zipCode
     * @param _countryCode
     *
